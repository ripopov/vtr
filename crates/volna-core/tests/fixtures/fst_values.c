 ...
 * cc crates/volna-core/tests/fixtures/fst_values.c \
 ...
 * /tmp/volna-fst-values crates/volna-core/tests/fixtures/values.fst
 * /tmp/volna-fst-values crates/volna-core/tests/fixtures/values-wrapped.fst wrap
 */
#include "fstapi.h"
#include <assert.h>
