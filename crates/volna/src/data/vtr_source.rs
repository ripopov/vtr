//! [`WaveSource`] backed by a VTR file through the `vtr` reader crate.
...
use super::source::{Direction, Hierarchy, Scope, SignalRef, TraceInfo, Variable, WaveSource};
use super::value::{Bit, SignalShape, WaveValue};

pub struct VtrSource {
    reader: Reader,
    info: TraceInfo,
    hierarchy: Hierarchy,
}
