...
The capture must hold one clk stretch of period 2 (200 ps in 100 ps units)
starting on the first rising edge of the recorded clk waveform, with as many
edges as that waveform has rising edges.
...
def main():
    ...
    assert re.match(r'clock 0 TOP\.top\.clk: \d+ edges, 1 stretches, stopped 0, running at close$', out[0]), out
