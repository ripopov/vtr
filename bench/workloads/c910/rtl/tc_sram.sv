// Vendored from https://github.com/pulp-platform/tech_cells_generic (src/rtl/tc_sram.sv),
// the behavioural SRAM that pulp-c910 substitutes for the C910 macros (vendor patch 0009).
